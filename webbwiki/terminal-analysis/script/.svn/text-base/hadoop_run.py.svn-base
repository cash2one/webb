...
def getBaseInfo(logdate):
    basedir = "/home/users/panfayi/local/hadoop-client/hadoop"
    inputpath = "hdfs://szwg-ecomon-hdfs.dmop.baidu.com:54310/app/ns/udw/release/app/ud/main/ud_ml_wise_merge_data2/partition_stat_date=%s/*" % logdate
    # 不跑全量，取1%的数据分析
